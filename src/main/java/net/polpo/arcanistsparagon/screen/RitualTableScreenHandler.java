...
public class RitualTableScreenHandler extends ScreenHandler {
    ...
    public final RitualTableBlockEntity blockEntity;
    ...
    public RitualTableScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.RITUAL_TABLE_SCREEN_HANDLER, syncId);
        checkSize((Inventory) blockEntity, 2);
        this.inventory = ((Inventory) blockEntity);
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity =  ((RitualTableBlockEntity) blockEntity);
