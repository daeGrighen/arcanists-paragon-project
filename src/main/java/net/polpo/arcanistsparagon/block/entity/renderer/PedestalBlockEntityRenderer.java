...
public class PedestalBlockEntityRenderer implements BlockEntityRenderer<RitualPedestalBlockEntity> {

    public PedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context){

    }
    @Override
    public void render(RitualPedestalBlockEntity entity, float tickDelta,
